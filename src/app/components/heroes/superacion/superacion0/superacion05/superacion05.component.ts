...
@Component({
  selector: 'app-superacion05',
  templateUrl: './superacion05.component.html',
  styleUrls: ['./superacion05.component.css']
})
export class Superacion05Component implements OnInit {

...
@Component({
  selector: 'app-superacion07',
  templateUrl: './superacion07.component.html',
  styleUrls: ['./superacion07.component.css']
})
export class Superacion07Component implements OnInit {

...
@Component({
  selector: 'app-superacion01',
  templateUrl: './superacion01.component.html',
  styleUrls: ['./superacion01.component.css']
})
export class Superacion01Component implements OnInit {

...
@Component({
  selector: 'app-ensenanzas07',
  templateUrl: './ensenanzas07.component.html',
  styleUrls: ['./ensenanzas07.component.css']
})
export class Ensenanzas07Component implements OnInit {

...
@Component({
  selector: 'app-ensenanzas05',
  templateUrl: './ensenanzas05.component.html',
  styleUrls: ['./ensenanzas05.component.css']
})
export class Ensenanzas05Component implements OnInit {

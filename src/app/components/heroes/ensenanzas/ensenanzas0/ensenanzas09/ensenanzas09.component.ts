...
@Component({
  selector: 'app-ensenanzas09',
  templateUrl: './ensenanzas09.component.html',
  styleUrls: ['./ensenanzas09.component.css']
})
export class Ensenanzas09Component implements OnInit {

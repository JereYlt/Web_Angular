...
@Component({
  selector: 'app-ensenanzas06',
  templateUrl: './ensenanzas06.component.html',
  styleUrls: ['./ensenanzas06.component.css']
})
export class Ensenanzas06Component implements OnInit {

...
@Component({
  selector: 'app-ensenanzas01',
  templateUrl: './ensenanzas01.component.html',
  styleUrls: ['./ensenanzas01.component.css']
})
export class Ensenanzas01Component implements OnInit {
